...
| `oneOf`               | <empty> | `oneOf: ["open", "closed", "suspended"]`                        | Field can only take one of the prescribed values                                                                                                                                                                                                                                                |
| `oneOfWeighted`       | <empty> | `oneOfWeighted: ["open->0.8", "closed->0.1", "suspended->0.1"]` | Field can only take one of the prescribed values. Chance of value being chosen is based on the weight assigned to it. Weight can be any double value.                                                                                                                                           |
...
| `incremental`           | <empty>     | `incremental: ""`              | Values will be incremental. Starting from 1 until number of rows generated          |
